...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,107);function f(x,k){const d=c("ExternalLinkIcon");return a(),r("div",null,[l,e("div",u,[h,e("p",null,[v,e("a",p,[m,s(d)]),b])]),g])}const w=t(o,[["render",f],["__file","7.html.vue"]]);export{w as default};
